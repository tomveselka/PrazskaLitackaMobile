    ...
    private static RoomDatabase.Callback roomCallback = new RoomDatabase.Callback(){
        ...
        public void onCreate(@NonNull SupportSQLiteDatabase db){
            ...
            executorService.execute(new Runnable() {
                @Override
                public void run() {
                    rowDao.insertRow(new RowEntity(false,5,false,"Křižíkova",false,6,false,"Invalidovna",false,4,false,"24","tram",false,null,15,1));
                    rowDao.insertRow(new RowEntity(true,0,false,"Invalidovna",false,6,false,"Českomoravská",false,2,false,"B","metro",false, null, 8,1));
                    rowDao.insertRow(new RowEntity(true,0,false,"Českomoravská",false,31,true,"Klíčov",false,3,false,"151","bus",true,"odklon",38,1));
                }
            });
        }
    };
